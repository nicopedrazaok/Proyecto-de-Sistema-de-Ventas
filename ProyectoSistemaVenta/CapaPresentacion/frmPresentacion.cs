...
namespace CapaPresentacion
{
    public partial class frmPresentacion : Form
    {
        ...
        {
            InitializeComponent();
            this.ttMensaje.SetToolTip(txtIdPresentacion, "Codigo del Registro");
        ...
        {
            this.DataListadoPresentacion.DataSource = NPresentacion.Mostrar();
            this.OcultarColumnas();
            lblTotal.Text = "Total de Registros: " + Convert.ToString(DataListadoPresentacion.Rows.Count);
        }
        private void BuscarNombre()
        {
            this.DataListadoPresentacion.DataSource = NPresentacion.BuscarNombre(this.txtBuscarPresentacion.Text);
            this.OcultarColumnas();
            lblTotal.Text = "Total de Registros: " + Convert.ToString(DataListadoPresentacion.Rows.Count);
        }
        ...
        {
            this.txtIdPresentacion.Text = Convert.ToString(this.DataListadoPresentacion.CurrentRow.Cells["Id Presentacion"].Value);
            this.txtNombre.Text = Convert.ToString(this.DataListadoPresentacion.CurrentRow.Cells["Nombre"].Value);
            this.txtDescripcion.Text = Convert.ToString(this.DataListadoPresentacion.CurrentRow.Cells["Descripcion"].Value);
